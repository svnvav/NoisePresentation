...
{
    public class SimplexGradient3DSliceOutput : MonoBehaviour
    {
        ...
        public void UpdateTargets()
        {
            ...
            var gradientsBuffer = new ComputeBuffer(NoiseUtility.SimplexGradients.Length, sizeof(float) * 3, ComputeBufferType.Default);
            gradientsBuffer.SetData(NoiseUtility.SimplexGradients);
